                        ...
                        <div :style="{ display: 'flex', justifyContent: 'space-between' }">
                            ...
                            <div class="mb-3">
                                <label for="dateof" class="form-label">{{ $t("Date Of Birth") }}<span
                                        class="text-danger">*</span></label>
                                <input type="date" id="dateof" v-model="user.dateof" class="form-control" required />
                            </div>
                        </div>
                        <div :style="{ display: 'flex', justifyContent: 'space-between' }">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="phone" class="form-label">{{ $t("Phone") }}<span
                                        class="text-danger">*</span></label>
                                <input type="tel" id="phone" v-model="user.phone" class="form-control" required
                                    pattern="^[0-9]+$" inputmode="numeric" @input="validatePhone" />
                            </div>
                        </div>
