    ...
    <div class="login-container" :class="{ rtl: isRTL }">
        ...
        <form @submit.prevent="handleLogin" class="form">
            ...
            <div class="mb-3 input-group">
                ...
                <input class="form-control" :type="showPassword ? 'text' : 'password'" id="password" v-model="password"
                    required />
                <i @click="togglePassword" v-if="!showPassword" class="eye bi bi-eye-fill"></i>
                <i @click="togglePassword" v-if="showPassword" class="eye bi bi-eye-slash-fill"></i>
            </div>
