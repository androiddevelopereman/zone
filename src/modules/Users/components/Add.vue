...
const saveZone = async () => {
    ...
    try {
        ...
        saveError.value = `Error saving zone: ${err.response?.data?.message || err.message || 'Unknown error'}`
    } finally {
...
<template>
    <div class="container">
        ...
        <div class="form-container">
            <input type="text" v-model="zoneName" placeholder="Zone Name" class="input-field" />
            <input type="text" v-model="zoneDescription" placeholder="Zone Description" class="input-field" />
