...
const routes = [
  ...
  { path: '/calenderfunction', name: 'CalenderFunction', component: CalenderFunction,meta: { title: 'CalenderFunction' }  },
  { path: '/mapview', name: 'MapView', component: MapView,meta: { title: 'MapView' }  },
  { path: '/zonesmodule', name: 'ZonesModule', component: ZonesModule,meta: { title: 'ZonesModule' }  },
  { path: '/addzone', name: 'AddZone', component: AddZone,meta: { title: 'AddZone' }  },
  { path: '/editzone', name: 'EditZone', component: EditZone,meta: { title: 'EditZone' }  },
